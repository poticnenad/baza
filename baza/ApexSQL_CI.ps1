...
$notificationSettings = New-ApexSQLNotificationSettings -EmailAddress "poticnenad@gmail.com" -PasswordFile "GMail" -SmtpServer "smtp.gmail.com" -Port 587 -UseSSL
...
$dsQA = New-ApexSqlDatabaseConnection -ConnectionName "qaDB_dest" -Server "." -Database "izCLIa" -UserName "sa" -PasswordFile "DB"
...
#Package step
Invoke-ApexSqlPackageStep -Options $options -nugetVersion "10.0.12" -nugetReleaseNotes "Release_notes_here" -Publish | Out-Null
