...
GO
CREATE TRIGGER [dbo].[tr_i_AUDIT_Table_2]
ON [dbo].[Table_2]
FOR INSERT
	NOT FOR REPLICATION
As
...
-- Description:  INSERT TRIGGER for Table:  [dbo].[Table_2]
...
End
GO
EXEC sp_settriggerorder @triggername= '[dbo].[tr_i_AUDIT_Table_2]', @order='Last', @stmttype='INSERT'
GO
