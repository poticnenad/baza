...
GO
CREATE TRIGGER [abc].[tr_d_AUDIT_Table_1]
ON [abc].[Table_1]
FOR DELETE
	NOT FOR REPLICATION
AS
...
-- Description:  DELETE TRIGGER for Table:  [abc].[Table_1]
...
END
GO
EXEC sp_settriggerorder @triggername= '[abc].[tr_d_AUDIT_Table_1]', @order='Last', @stmttype='DELETE'
GO
